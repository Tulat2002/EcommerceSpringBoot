...
import com.devanktu.ecommerce.dto.CartItemsDto;
...
import com.devanktu.ecommerce.repository.*;
...
//        if (activeOrder == null) {
//            throw new IllegalArgumentException("No active order found for user ID: " + userId);
//        }
